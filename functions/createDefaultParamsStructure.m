...
createParam('sideCamPosVec_cm',[2 43 42],-100,100,...
...
createParam('slntCamPosVec_cm',[31 1.2 37.5],-100,100,...
...
createParam('prscpeCamPosVec_cm',[44 4 20],-100,100,...
...
% Water Channel - 1.649
% Kite (boom) 2.036
createParam('sideDotSepDist_cm',2.036,0,10,...
    'Side dots separation distance.','cm')
% Old - [0.091 4.54 0.878]
% Dummy [-0.337 4.54 0.857]
% Kite (boom) [-3.9 0 0]
createParam('sideDotPosVec_cm',[2.3 0 0],-20,20,...
...
createParam('botADotPosVec_cm',[-2.3 0 0.2],-20,20,...
    'Bottom A dots centroid in body fixed coordinates','cm')
% Bottom B Dots
% Dummy - 2.206
% Water Channel - 2.194
createParam('botBDotSepDist_cm',2.9,0,10,...
    'Bottom B dots separation distance.','cm')
% Old - [-1 0 -4.64]
%dummy [-1.152 0 -4.751]
createParam('botBDotPosVec_cm',[0.1 0 0],-20,20,...
    'Bottom B dots centroid in body fixed coordinates','cm')
% Top/Back Dots
% top - 2.034
createParam('topDotSepDist_cm',2.0,0,10,...
    'Top dots separation distance.','cm')
% BAT = 1.865
% Kite_2 = 3.6  
% top_old - [2.818 0 3.802]
% Kite (boom) [6.7 0 0]
createParam('topDotPosVec_cm',[6.7 0 1],-20,20,...
...
createParam('prscpeDistancetoGlass_cm',3.75,0,50,...
...
createParam('roiSideSize_px',[40 120],0,500,...
...
createParam('roiSlntSize_px',[120 450],0,500,...
