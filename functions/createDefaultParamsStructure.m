...
createParam('sideCamPosVec_cm',[16 42 35],-100,100,...
...
createParam('botCamPosVec_cm',[14 3.5 -6.25],-100,100,...
...
createParam('slntCamPosVec_cm',[-21 3 -7],-100,100,...
...
% Dummy - 1.6
% Water Channel - 2.1
createParam('botADotSepDist_cm',2.1,0,10,...
...
% Dummy - 2.6
% Water Channel - 2.2
createParam('botBDotSepDist_cm',2.2,0,10,...
