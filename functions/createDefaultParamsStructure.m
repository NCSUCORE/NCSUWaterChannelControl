...
createParam('initCoMPosVec_cm',[2 0 61.5],-100,100,...
...
% Side camera 6DOF
% Dummy - [19 40 43], new origin - [11.5 39.5 67.5]
% Water Channel - [16 42 35]
createParam('sideCamPosVec_cm',[11.5 39.5 67.5],-100,100,...    'Side camera position vector.','cm')
...
% Bottom camera 6DOF
% Dummy - [20 1 -3], new origin - [12 0 23]
% Water Channel - [14 3.5 -6.25]
createParam('botCamPosVec_cm',[12 0 23],-100,100,...
...
% Slant camera 6DOF
% Dummy - [-22 1 -1], new origin - [-32 0 25]
% Water Channel - [-21 3 -7]
createParam('slntCamPosVec_cm',[-32 0 25],-100,100,...
...
% Dummy - 2.31
% Water Channel - 1.6
createParam('sideDotSepDist_cm',2.31,0,10,...
...
% Dummy - 1.51
% Water Channel - 2.1
createParam('botADotSepDist_cm',1.51,0,10,...
...
% Dummy - 2.27
% Water Channel - 2.2
createParam('botBDotSepDist_cm',2.27,0,10,...
