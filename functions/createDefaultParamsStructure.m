...
createParam('sideCamPosVec_cm',[7 43.5 36.5],-100,100,...
...
createParam('prscpeCamPosVec_cm',[25 3 30.5],-100,100,...
...
% Water Channel - 1.649
% Kite (boom) 2.036
createParam('sideDotSepDist_cm',1.6,0,10,...
    'Side dots separation distance.','cm')
% Old - [0.091 4.54 0.878]
% Dummy [-0.337 4.54 0.857]
% Kite (boom) [-3.9 0 0]
createParam('sideDotPosVec_cm',[3.3 0 0],-20,20,...
...
createParam('botADotPosVec_cm',[-3.4 0 -0.6],-20,20,...
    'Bottom A dots centroid in body fixed coordinates','cm')
% Bottom B Dots
% Dummy - 2.206
% Water Channel - 2.194
createParam('botBDotSepDist_cm',3.2,0,10,...
...
% Kite (boom) [6.7 0 0]
createParam('topDotPosVec_cm',[6.8 0 0.36],-20,20,...
...
createParam('sideDistancetoGlass_cm',0.5,0,50,...
    'Side camera distance to glass','cm')
createParam('botDistancetoGlass_cm',0.5,0,50,...
