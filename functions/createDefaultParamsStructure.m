...
% Side camera 6DOF
createParam('sideCamPosVec_cm',[14.7 29 28],-100,100,...
...
% Bottom camera 6DOF
createParam('botCamPosVec_cm',[17.1 -1 -13.8],-100,100,...
...
% Slant camera 6DOF
createParam('slntCamPosVec_cm',[-24 -1 -11],-100,100,...
...
createParam('roiSideSize_px',[90 120],0,500,...
