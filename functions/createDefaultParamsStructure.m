...
% Side camera 6D
% Dummy - [14.7 29 28]
createParam('sideCamPosVec_cm',[17 45.25 33],-100,100,...
...
% Bottom camera 6DOF
% Dummy - [17.1 -1 -13.8]
createParam('botCamPosVec_cm',[15 0 -4.45],-100,100,...
...
% Slant camera 6DOF
% Dummy - [-24 -1 -11]
createParam('slntCamPosVec_cm',[-21.6 0 -4.45],-100,100,...
...
% Side Dots
% Dummy - 2.4
createParam('sideDotSepDist_cm',2.5,0,10,...
...
% Bottom A Dots
% Dummy - 1.6
createParam('botADotSepDist_cm',2.2,0,10,...
...
% Bottom B Dots
% Dummy - 2.6
createParam('botBDotSepDist_cm',2.25,0,10,...
