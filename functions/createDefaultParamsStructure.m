...
% Side camera 6DOF
% Dummy (Bot Cam Origin) - [5 40 65]
% Water Channel - [-7.5 44.7 47.1]
createParam('sideCamPosVec_cm',[5 40 65],-100,100,...
...
% Bottom camera 6DOF
% Dummy (Bot Cam Origin) - [0 0 23]
% Water Channel - [22 -6 -8]
createParam('botCamPosVec_cm',[0 0 23],-100,100,...
...
createParam('slntCamPosVec_cm',[-44 0 25.5],-100,100,...
...
% Periscope camera 6DOF
createParam('prscpeCamPosVec_cm',[36 0 61.5],-100,100,...
...
createParam('sideDotPosVec_cm',[-0.337 4.54 0.857],-20,20,...
    'Position of side dots centroid in body fixed coordinates','cm')
% Bottom A Dots
% Dummy - 1.88
% Water Channel - 2.008
createParam('botADotSepDist_cm',1.88,0,10,...
    'Bottom A dots separation distance.','cm')
% Old - [2.48 0 -4.53]
createParam('botADotPosVec_cm',[2.049 0 -4.546],-20,20,...
    'Bottom A dots centroid in body fixed coordinates','cm')
% Bottom B Dots
% Dummy - 2.206
% Water Channel - 2.194
createParam('botBDotSepDist_cm',2.206,0,10,...
    'Bottom B dots separation distance.','cm')
% Old - [-1 0 -4.64]
createParam('botBDotPosVec_cm',[-1.152 0 -4.751],-20,20,...
    'Bottom B dots centroid in body fixed coordinates','cm')
% Top Dots
% top - 2.034
createParam('topDotSepDist_cm',1.865,0,10,...
    'Top dots separation distance.','cm')
% top - [2.818 0 3.802]
createParam('topDotPosVec_cm',[4.314 0 3.343],-20,20,...
...
createParam('roiBotBSize_px',[50 115],0,500,...
...
createParam('roiSlntSize_px',[50 120],0,500,...
