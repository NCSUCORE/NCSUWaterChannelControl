...
snells(7).camPosVec = params.slntCamPosVec_cm.Value(:);
snells(7).camEulAng = params.slntCamEulAng_deg.Value(:);
snells(7).camDist2Glass = params.slntDistancetoGlass_cm.Value;
